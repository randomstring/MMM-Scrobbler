Module.register("MMM-Scrobbler",{
	...
	if(this.songData.playing === "true"){
		...
		albumart_html += "<div class='album-art-container'>"
		    + "<div class='album-art'><img src='"
		    + this.songData.image
		    +"' width='200'></div></div>";
	    }
	    if(this.config.showMetaData){
		meta_html += "<div class='meta'><table class='small'><tr class='track-name bright'><td>"
		    + this.songData.title
		    + "</td></tr><tr class='artist-name'><td>"
		    + this.songData.artist
		    + "</td></tr><tr class='album-name dimmed'><td>"
		    + this.songData.album
		    + "</td></tr></table></div>";
	    }
